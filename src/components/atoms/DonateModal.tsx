...
type ButtonLocation = "default" | "hero" | "section";
    ...
    <>
      <div className=" inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto md:ml-6 sm:pr-0">
        <div className={"w-full items-center justify-center"}>
          <Button
            type="button"
            size={buttonLocation === "hero" ? "lg" : "default"}
            onClick={openModal}
          >
            Donate
          </Button>
              ...
              >
                <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all bg-card">
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex-1 pr-4">
                          ...
                          <p className="text-white font-light text-lg sm:text-xl leading-relaxed drop-shadow-sm">
                            Support our work. Donate securely via card, mobile
                  ...
                  <div className="py-2 lg:py-4 px-4 mx-auto max-w-screen-md">
                    <form className="space-y-2">
                      <Field>
                        ...
                        <Input
                          ...
                          required
                          className={clsx(
                            "my-2 block w-full rounded-lg border border-slate-300 bg-slate-200 px-3 py-1.5 text-sm/6 text-black",
                    ...
                    <PaystackButton
                      disabled={!paystackProps.email || !paystackProps.amount}
                      className={cn(
                        "w-full my-4",
