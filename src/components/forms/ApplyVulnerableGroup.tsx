...
const ApplyVulnerableGroupForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const _postResponse = await fetch("/api/apply/vulnerable-group", {
        method: "POST",
        body: formData,
      });
      ...
      console.error(
        "ERROR in ApplyVulnerableGroupForm form: ",
...
export default ApplyVulnerableGroupForm;
