...
const ApplySpecialProjectForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const _postResponse = await fetch("/api/apply/special-project", {
        method: "POST",
        body: formData,
      });
      ...
      console.error(
        "ERROR in ApplySpecialProjectForm form: ",
...
export default ApplySpecialProjectForm;
